...
void *mergesort(void *data) {
	...
	pthread_create(&left_thread, NULL, mergesort, &left_side);
        pthread_create(&right_thread, NULL, mergesort, &right_side);
    } else {
...
int main (int argc, char *argv[]) {
    ...
    clock_t start = clock();
    rc = pthread_create(&thread, NULL, mergesort, (void *)&struct_data);
    if (rc){
